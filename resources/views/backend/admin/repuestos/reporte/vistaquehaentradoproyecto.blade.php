...
@section('title', 'Reporte Entrado Proyecto')
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="callout callout-info">
                        <h5 style="font-weight: bold"><i class="fas fa-info"></i> Entrada de Materiales por Proyecto</h5>
                        <div class="card">
...
@section('js')
    ...
    <script>
        ...
        function generarPdf() {
            ...
            var desde  = document.getElementById('fecha-desde').value || 'null';
            var hasta  = document.getElementById('fecha-hasta').value || 'null';
